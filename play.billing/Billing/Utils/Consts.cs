...
namespace play.billing
{
    ...
    public const string MARKET_BILLING_SERVICE_ACTION =
    ...
    public const string ACTION_CONFIRM_NOTIFICATION =
            "com.example.subscriptions.CONFIRM_NOTIFICATION";
    public const string ACTION_GET_PURCHASE_INFORMATION =
            "com.example.subscriptions.GET_PURCHASE_INFORMATION";
    public const string ACTION_RESTORE_TRANSACTIONS =
    ...
    public const string ACTION_RESPONSE_CODE =
        "com.android.vending.billing.RESPONSE_CODE";
    public const string ACTION_PURCHASE_STATE_CHANGED =
    ...
    public const long BILLING_RESPONSE_INVALID_REQUEST_ID = -1;
